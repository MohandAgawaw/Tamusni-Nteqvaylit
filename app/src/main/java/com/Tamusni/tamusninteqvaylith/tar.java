...
public class tar extends AppCompatActivity {
    ...
    private void preparemediaplyr(){
        Query query = Myref.child("timucuha").child("post4");
    ...
    private void msk() {
        mp = MediaPlayer.create(this, R.raw.riretar);
        mp.start();
    ...
    private  void  nrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post4").child("like")
    ...
    private  void  nonrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                liKe.setText(dataSnapshot.getChildrenCount()+" ");
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post4").child("dislike")
                        .setValue(dataSnapshot.getChildrenCount()+"");
            }
    ...
    protected void onStart() {
            ...
            public void onClick(View view) {
                if(btnih.getTag().equals("Like")){
                    if(btnuhu.getTag().equals("noLiked")){
                        ...
                        Toast.makeText(tar.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
                    }else {
                        Toast.makeText(tar.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
                        FirebaseDatabase.getInstance().getReference().child("LIKES").child(postid)
                                .child(firebaseUser.getUid()).setValue(true);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String titell = " " + dataSnapshot.child("post4").child("name4").getValue().toString();
                    String hi = " " + dataSnapshot.child("post4").child("hi").getValue().toString();
                    String image1 = dataSnapshot.child("post4").child("pic1").getValue().toString();
                    String image2 = dataSnapshot.child("post4").child("pic2").getValue().toString();
                    String image3 = dataSnapshot.child("post4").child("pic3").getValue().toString();
