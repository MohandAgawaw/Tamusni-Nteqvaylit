...
public class tam_tasenzikt_tibladin_tissira extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tasenzikt_tibladin_tissira);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tasenzikt_ifran_tissira");
