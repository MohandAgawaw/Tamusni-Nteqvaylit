...
public class tam_amarkal_igemad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_amarkal_igemad);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_amrakal_igemad");
