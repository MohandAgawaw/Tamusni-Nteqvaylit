...
public class tam_rryac_igharsiwen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_rryac_igharsiwen);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_Rryac_igharsiwen");
