...
public class tasadicitan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tasadicitan);
    ...
    private void preparemediaplyr(){
        Query query = Myref.child("timucuha").child("post5");
    ...
    private  void  nrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post5").child("like")
    ...
    private  void  nonrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                liKe.setText(dataSnapshot.getChildrenCount()+" ");
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post5").child("dislike")
                        .setValue(dataSnapshot.getChildrenCount()+"");
            }
    ...
    protected void onStart() {
            ...
            public void onClick(View view) {
                if(btnih.getTag().equals("Like")){
                    if(btnuhu.getTag().equals("noLiked")){
                        ...
                        Toast.makeText(tasadicitan.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
                    }else {
                        FirebaseDatabase.getInstance().getReference().child("LIKES").child(postid)
                                .child(firebaseUser.getUid()).setValue(true);
                        Toast.makeText(tasadicitan.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();;
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String titell = " " + dataSnapshot.child("post5").child("name5").getValue().toString();
                    String hi = " " + dataSnapshot.child("post5").child("hi").getValue().toString();
                    String image1 = dataSnapshot.child("post5").child("pic1").getValue().toString();
                    String image2 = dataSnapshot.child("post5").child("pic2").getValue().toString();
                    String image3 = dataSnapshot.child("post5").child("pic3").getValue().toString();
