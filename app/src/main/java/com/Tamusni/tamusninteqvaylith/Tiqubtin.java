...
public class Tiqubtin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiqubtin);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String texteinfo = "" + dataSnapshot.child("tiqubtin").getValue().toString();
                    if(texteinfo != ""){
                        try {
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tiqubtin");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    tiwelfinee.setDescription(snapshot.child("namee").getValue().toString());
