...
public class tam_tirra_tahnayin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tirra_tahnayin);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tirra_tahnayin");
