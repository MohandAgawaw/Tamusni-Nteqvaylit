...
public class tam_igharsiwen_tiniri extends AppCompatActivity {
    RecyclerView recyclerView;
    private DatabaseReference Myref;
    private ArrayList<tam_info> messagesList;
    private tam_info_adap adapter; LinearLayout cnx;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tam_igharsiwen_tiniri);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("ighatiniri");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    messagesList.add(tiwelfinee);cnx = findViewById(R.id.netlong);
                }
    ...
    public void onBackPressed() {
        ...
        startActivity(new Intent(getApplicationContext(),igharsiwen.class));
        finish();
