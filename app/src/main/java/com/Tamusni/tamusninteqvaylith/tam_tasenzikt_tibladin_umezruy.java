...
public class tam_tasenzikt_tibladin_umezruy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tasenzikt_tibladin_umezruy);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tasenzikt_tibladin_umezruy");
