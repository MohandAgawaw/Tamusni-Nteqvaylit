...
public class quizz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String LVL = intent.getStringExtra(activity_starting_screen.EXTRA_LVL);
        String sniper = intent.getStringExtra(activity_starting_screen.EXTRA_DIFFICULTY);
        ...
        if(iflvl != 7){
            ...
            if (savedInstanceState == null) {
                ...
                questionList = dbHelper.getQuestions(lvll);
            ...
            if (savedInstanceState == null) {
                QuizDbHelper dbHelper = new QuizDbHelper(this);
                questionList = dbHelper.getQuestions(sniper);
                questionCountTotal = questionList.size();
                Collections.shuffle(questionList);
                showNextQuestion();
            } else {
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()||rb4.isChecked()) {
                        ...
                        Toast.makeText(quizz.this, "ileɛnaya-k (m) ! fren tiririt .", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
