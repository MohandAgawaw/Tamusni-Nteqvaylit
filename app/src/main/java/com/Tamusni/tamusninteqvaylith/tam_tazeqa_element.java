...
public class tam_tazeqa_element extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tazeqa_element);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tazeqa_aferdis");
