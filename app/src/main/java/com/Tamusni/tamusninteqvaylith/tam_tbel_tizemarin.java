...
public class tam_tbel_tizemarin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tbel_tizemarin);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tbel_tizemarin");
