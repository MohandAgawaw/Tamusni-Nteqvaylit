...
public class tam_igharsiwen_yetfarfiren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_igharsiwen_yetfarfiren);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("ighaferfer");
