...
public class tawkilt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tawkilt);
    ...
    private void preparemediaplyr(){
        Query query = Myref.child("timucuha").child("post2");
    ...
    private  void  nrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post2").child("like")
    ...
    private  void  nonrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                liKe.setText(dataSnapshot.getChildrenCount()+" ");
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post2").child("dislike")
                        .setValue(dataSnapshot.getChildrenCount()+"");
            }
    ...
    protected void onStart() {
            ...
            public void onClick(View view) {
                if(btnih.getTag().equals("Like")){
                    if(btnuhu.getTag().equals("noLiked")){
                        ...
                        Toast.makeText(tawkilt.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
                    }else {
                        FirebaseDatabase.getInstance().getReference().child("LIKES").child(postid)
                                .child(firebaseUser.getUid()).setValue(true);
                        Toast.makeText(tawkilt.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String titell = " " + dataSnapshot.child("post2").child("name2").getValue().toString();
                    String hi = " " + dataSnapshot.child("post2").child("hi").getValue().toString();
                    String image1 = dataSnapshot.child("post2").child("pic1").getValue().toString();
                    String image2 = dataSnapshot.child("post2").child("pic2").getValue().toString();
                    String image3 = dataSnapshot.child("post2").child("pic3").getValue().toString();
