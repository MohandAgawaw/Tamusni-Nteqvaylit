...
public class tam_tasenzikt_azru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tasenzikt_azru);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tasenzikt_azru");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    tiwelfinee.setUrlmimgg(snapshot.child("testt").getValue().toString());
