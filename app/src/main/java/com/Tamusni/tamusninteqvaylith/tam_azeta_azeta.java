...
public class tam_azeta_azeta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_azeta_azeta); recyclerView = findViewById(R.id.RecyclerView);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_azzeta_azeta");
    ...
    private void preparemediaplyr(){
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String texteinfo = "" + dataSnapshot.child("azzeta").getValue().toString();
                    if(texteinfo != ""){
                        try {
