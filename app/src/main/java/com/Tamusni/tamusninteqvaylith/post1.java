...
String postid = "Poste 1" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("timucuha");
    ...
    private void preparemediaplyr(){
        ...
        databaseReference.child("post1").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private  void  nrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post1").child("like")
    ...
    private  void  nonrLikes(final TextView liKe,String postid){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                liKe.setText(dataSnapshot.getChildrenCount()+" ");
                FirebaseDatabase.getInstance().getReference().child("timucuha").child("post1").child("dislike")
                        .setValue(dataSnapshot.getChildrenCount()+"");
            }
            ...
            public void onClick(View view) {
                if(btnih.getTag().equals("Like")){
                    if(btnuhu.getTag().equals("noLiked")){
                        ...
                        Toast.makeText(post1.this, "Tanmirt \uD83E\uDD70", Toast.LENGTH_SHORT).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    String titell = " " + dataSnapshot.child("post1").child("name1").getValue().toString();
                    String hi = " " + dataSnapshot.child("post1").child("hi").getValue().toString();
                    String image1 = dataSnapshot.child("post1").child("pic1").getValue().toString();
                    String image2 = dataSnapshot.child("post1").child("pic2").getValue().toString();
                    String image3 = dataSnapshot.child("post1").child("pic3").getValue().toString();
