...
public class tam_tasenzikt_tibladin_amnay extends AppCompatActivity {
    RecyclerView recyclerView;
    private DatabaseReference Myref;
    private ArrayList<tam_info_vdofto> messagesList;
    private tam_info_vdofto_adp adapter;
    LinearLayout cnx;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tam_tasenzikt_tibladin_amnay);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tasenzikt_tibladin_amnay");
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    tam_info_vdofto tiwelfinee = new tam_info_vdofto();
                    ...
                    tiwelfinee.setLink(snapshot.child("link").getValue().toString());

                    messagesList.add(tiwelfinee);
                }

                cnx.setVisibility(View.INVISIBLE);
                adapter = new tam_info_vdofto_adp(getApplicationContext(),messagesList);
