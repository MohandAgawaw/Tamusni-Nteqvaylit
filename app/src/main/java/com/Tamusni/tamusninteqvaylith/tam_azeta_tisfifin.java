...
public class tam_azeta_tisfifin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_azeta_tisfifin); recyclerView = findViewById(R.id.RecyclerView);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_azzeta_tisfifin");
