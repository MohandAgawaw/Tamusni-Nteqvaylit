...
public class tam_tasenzikt_ifran_ifran extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tam_tasenzikt_ifran_ifran);
    ...
    protected void onStart() {
        super.onStart();
        Query query = Myref.child("tam_tasenzikt_ifran_ifri");
